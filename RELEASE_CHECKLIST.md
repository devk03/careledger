...
- [ ] The owner recovery root is never issued to a limited member. Distinct day/source keys and recipient-bound envelopes enforce current grants; a member with one day key cannot decrypt another day, hidden source, or undated draft. Care dates and the date-to-opaque-ID index remain encrypted.

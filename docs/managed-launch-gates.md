...
1. Obtain separate approval to apply the ten registered managed drafts **only** to a
   ...
   Keep the historical-backfill writer unmounted until its distinct signed
   action and transactional behavior pass fictional database tests.

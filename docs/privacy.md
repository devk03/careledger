...
Adeno is self-hosted software, not a hosted medical service.
...
Adeno requests `store: false`, but that setting alone does not provide a Business Associate Agreement, Zero Data Retention, or HIPAA compliance. Operators must evaluate their legal obligations, configure an eligible provider agreement and data controls where required, secure hosting and backups, and obtain appropriate consent before processing protected health information.
